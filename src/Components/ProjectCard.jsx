...
function ProjectCard({ projectName, projectLink }) {
  return (
    <div className="flex-col items-center border-none shadow-sm shadow-gray-700  p-10 w-60 h-56 rounded-lg transition-all duration-300 bg-gradient-to-r from-indigo-950 to-zinc-900 hover:shadow-gray-700 hover:shadow-md relative">
